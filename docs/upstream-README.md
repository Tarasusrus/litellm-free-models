> **Upstream README** — kept verbatim from [natorus87/litellm-free-models](https://github.com/natorus87/litellm-free-models)
> as the reference for providers, models, K8s and multi-instance setups. The fork's own
> README is [../README.md](../README.md); the fork-specific conventions are in
> [adr/0001-fork-conventions.md](adr/0001-fork-conventions.md).
