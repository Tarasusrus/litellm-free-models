...
> Snapshot: 2026-08-24 · 74 configured aliases plus the native image route · operational proxy price: **$0** within provider free-tier limits.
...
Coverage: **13 official**, **33 LiteLLM DB**, **29 estimated**.
...
|---|---:|---:|---:|---:|---|
| `kimi-k3` | chat | $3.000 | $15.000 | **$9.000** | LiteLLM DB: `moonshot/kimi-k3` |
| `command-r-plus` | chat | $2.500 | $10.000 | **$6.250** | official: Cohere |
| `kimi-k2.6` | chat | $0.950 | $4.000 | **$2.475** | LiteLLM DB: `azure_ai/kimi-k2.6` |
...
| `qwen3.6-35b-a3b` | chat | $0.250 | $1.500 | **$0.875** | LiteLLM DB: `scaleway/qwen/qwen3.6-35b-a3b` |
...
| `inkling-small` | chat | $0.300 | $1.200 | **$0.750** | estimate: unknown-size open-model benchmark |
...
| `deepseek-v4-pro` | chat | $0.435 | $0.870 | **$0.652** | LiteLLM DB: `tencent/deepseek-v4-pro` |
| `codestral-latest` | chat | $0.300 | $0.900 | **$0.600** | LiteLLM DB: `mistral/codestral-latest` |
...
| `deepseek-v4-flash-0731` | chat | $0.140 | $0.280 | **$0.210** | LiteLLM DB: `fireworks_ai/deepseek-v4-flash-0731` |
...
| `llama-4-maverick` | chat | $0.050 | $0.100 | **$0.075** | LiteLLM DB: `lambda_ai/llama-4-maverick-17b-128e-instruct-fp8` |
